...
export function wasm_bindgen__convert__closures__invoke1_mut__h705ef7b187927b67(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__hdc10a83546a23e59(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h0986bd4fc96da817(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__head1ac2f28bbfbdf(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h121d5c61a9bf67e8(a: number, b: number, c: number): void;
